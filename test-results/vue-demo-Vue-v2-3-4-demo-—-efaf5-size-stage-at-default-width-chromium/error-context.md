...
- Name: vue-demo.spec.ts >> Vue v2.3.4 demo — visual regression baselines >> resize stage at default width
- Location: tests\visual\vue-demo.spec.ts:37:3

# Error details

```
TimeoutError: locator.scrollIntoViewIfNeeded: Timeout 14779.742000000002ms exceeded.
Call log:
  - attempting scroll into view action
    ...
    - retrying scroll into view action
      - waiting 100ms
    23 × waiting for element to be stable
       - element is not stable
     - retrying scroll into view action
       - waiting 500ms
